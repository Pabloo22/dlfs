...
def vandermonde_matrix(b: int, points: list[tuple[Union[int, float]]]) -> 'np.ndarray[Union[int, float]]':
    """
...
def gen_points(num_points: int) -> list[tuple[Union[int, float]]]:
    """
...
def winograd(m: int, n: int) -> tuple['np.ndarray[Union[int, float]]']:
    """
    ...
    Returns:
        tuple[np.ndarray[Union[int, float]]]: A tuple with the aforementioned Y, X, W in this order.
    """
    num_points = m + n - 1
